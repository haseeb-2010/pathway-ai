      ...
      <div className="fixed top-4 md:top-8 left-1/2 -translate-x-1/2 z-50 w-[85%] md:w-[95%] max-w-5xl">
        <nav className="glass px-3 md:px-8 py-1.5 md:py-3 flex items-center justify-between rounded-full border border-white/10 shadow-[0_32px_64px_rgba(0,0,0,0.5)]">
          <div className="flex items-center shrink-0">
            <img src="/logo.svg" alt="Pathway Logo" className="h-8 md:h-12 w-auto object-contain ml-4 md:ml-2 scale-125" />
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16 md:mb-32 border-t border-white/5 pt-20 text-left">
            ...
            <div>
              ...
              <ul className="space-y-4 text-white/40 font-bold text-sm">
                <li><Link href="/about" className="hover:text-[#c1ff72] transition-colors">About Pathway</Link></li>
                <li><Link href="/mission" className="hover:text-[#c1ff72] transition-colors">Mission</Link></li>
                <li><Link href="/problem" className="hover:text-[#c1ff72] transition-colors">The Problem</Link></li>
                <li><Link href="/careers" className="hover:text-[#c1ff72] transition-colors">Careers</Link></li>
              </ul>
            </div>
            <div>
